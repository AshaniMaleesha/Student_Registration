                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        <div class="card-header">
                               Edit Student
                            <a href="{{ url('/all-students') }}" class="btn btn-success float-end">Back</a>
                            <hr>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="hometown" value="{{ $student->hometown}}" class="form-control"/>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <img id="previewImg" name="profileimage" src="{{ asset('images') }}/{{ $student->profileimage }}" style="max-width:130px;margin-top:20px;"/>
